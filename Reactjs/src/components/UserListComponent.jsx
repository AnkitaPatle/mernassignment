...
class UserListComponent extends Component {
  ...
  SearchUser(e) {
    ...
    var temparr = this.state.users.filter(ele => {
      return ele.UserName === criteria;
    });
        ...
        <div className="main-content">
          <div className="row roletable">
            ...
            <div className="col-md-8 border-table">
              <h4 className="text-center text-info">User List</h4>
              <div className="form-group marg-10">
                <label htmlFor="search" className="text-info col-md-1">
                  Search
                </label>
              ...
              <table className="table table-bordered table-striped">
                ...
                <tbody>
                  {// this.state.users.filter(searchengine(this.state.search))
                  this.state.users.map((r, i) => (
                    <TableRow
                      key={i}
                      row={r}
                      selected={this.getUserInfo.bind(this)}
                    />
                  ))}
                </tbody>
              </table>
...
class TableRow extends Component {
  ...
  render() {
    return (
      <tr>
        {Object.keys(this.props.row).map((r, i) =>
          r !== "_id" ? (
            r !== "__v" ? (
              r !== "Password" ? (
        ...
        <td>
          <a href="/personinfo">
            <input type="button" className="btn btn-primary" onClick={this.onRowClick.bind(this)} value="Add info" />
          </a>
        </td>
      </tr>
    );
...
//                 <tbody>
//                   {this.state.users.map((r, i) => (
//                     <TableRow key={i} row={r} users={this.state.users} />
//                   ))}
//                 </tbody>
//               </table>
//             </div>

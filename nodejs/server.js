...
var roles = require("./logics/roles.logic");
var users = require("./logics/users.logic");
var auth = require("./authentication/authentication");
var personInfo = require("./logics/personinformation.logic");
...
var jwtSettings = {
    jwtSecret: "ankita.patle@harbingergroup.com"
  };
